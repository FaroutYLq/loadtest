...
class Submit:
    ...
    def _load_config(self):
        """
        Load configuration from the config.ini file, though not necessarily everything will be used in the end.
        """
        ...
        assert self.peaks_log_dir is not None, "Please specify the peaks_log_dir in the config.ini file"
        assert self.events_log_dir is not None, "Please specify the events_log_dir in the config.ini file"
        ...
        assert self.peaks_result_folder is not None, "Please specify the peaks_result_folder in the config.ini file"
        assert self.events_result_folder is not None, "Please specify the events_result_folder in the config.ini file"
        ...
        assert self.peaks_output_folder is not None, "Please specify the peaks_output_folder in the config.ini file"
        assert self.events_output_folder is not None, "Please specify the events_output_folder in the config.ini file"
        self.peaks_storage_to_patch = config.get("context", "peaks_storage_to_patch", fallback=None)
        self.events_storage_to_patch = config.get("context", "events_storage_to_patch", fallback=None)
    ...
    def _verify_run_mode(self):
        ...
        assert is_sr0 or is_sr1, f'Invalid run mode: {self.run_mode}, you can choose from {self.sr0_modes} or {self.sr1_modes}'
